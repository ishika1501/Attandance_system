...
class Face_recognition_system:
       def __init__(self,root):       #Constructor
              ...
              #-------------------student button---------------------
              img4=Image.open(r"images\sq.jpg")
              ...
              #-----------------------detect face----------------------
              img5=Image.open(r"images\sq.jpg")
              ...
              img6=Image.open(r"images\sq.jpg")
              ...
              #---------------------Train data button-----------------------
              img8=Image.open(r"images\sq.jpg")
              ...
              #--------------------Photo face button----------------------
              img99=Image.open(r"images\sq.jpg")
              img99=img99.resize((1530,710),Image.ANTIALIAS)
              ...
              #img10=Image.open(r"images\sq.jpg")
