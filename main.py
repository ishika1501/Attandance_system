...
class Face_recognition_system:
       def __init__(self,root):       
              ...
              #-----------------------------------------------------background label------------------------------------------------------
              title_lbl=Label(bg_img,text="FACE  RECOGNISATION  ATTANDANCE  SYSTEM", font=("Humphrey",30,"bold"),bg="#afd9e4",fg="white")
              ...
              b1_1=Button(bg_img,text="Attendance",cursor="hand2",command=self.attendance_data,font=("Arial",15,"bold"),bg="white",fg="grey")
