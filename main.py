...
class Face_recognition_system:
    def __init__(self,root):       #Constructor
        ...
        #--------------------background label--------------------
        title_lbl=Label(bg_img,text="FACE RECOGNISATION ATTANDANCE SYSTEM", font=("Arial",25,"bold"),bg="white",fg="grey")
        title_lbl.place(x=0,y=0,width=1530,height=50)



        #-------------------student button---------------------
        img4=Image.open(r"C:\Users\my pc\Desktop\current_project\images\sq.jpg")
        ...
        #-----------------------detect face----------------------
        img5=Image.open(r"C:\Users\my pc\Desktop\current_project\images\sq.jpg")
        ...
        img6=Image.open(r"C:\Users\my pc\Desktop\current_project\images\sq.jpg")
        img6=img6.resize((1530,510),Image.ANTIALIAS)
        self.photoimg6=ImageTk.PhotoImage(img6)

        b1=Button(bg_img,image=self.photoimg6)
        b1.place(x=800,y=100,width=220,height=220)

        b1_1=Button(bg_img,text="Attandance",cursor="hand2",font=("Arial",15,"bold"),bg="white",fg="grey")
        b1_1.place(x=800,y=300,width=220,height=40)

        #---------------------Train data button-----------------------
        img8=Image.open(r"C:\Users\my pc\Desktop\current_project\images\sq.jpg")
        ...
        #--------------------Photo face button----------------------
        img9=Image.open(r"C:\Users\my pc\Desktop\current_project\images\sq.jpg")
        ...
        img10=Image.open(r"C:\Users\my pc\Desktop\current_project\images\sq.jpg")
