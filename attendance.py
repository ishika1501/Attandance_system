...
class Attendance:
    def __init__(self,root):
        ...
        atten_roll=ttk.Entry(left_inside_frame,textvariable=self.var_atten_name,width=20)
        ...
        self.atten_status=ttk.Combobox(left_inside_frame,textvariable=self.var_atten_attendance,font=("Arial",10,"bold"),width=17,state="read only")
