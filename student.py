...
class Student:
    def __init__(self, root):
        ...
        # ----------------------------------------------------------background image--------------------------------------------------------------
        img3 = Image.open(
            r"C:\Users\my pc\Desktop\current_project\images\abc.jpeg")
        ...
        Left_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE,
                                text="Student details", font=("Arial", 13, "bold"))
        ...
        current_course_frame = LabelFrame(
            main_frame, bd=2, bg="white", relief=RIDGE, text="Current course", font=("Arial", 15, "bold"))
        ...
        dep_combo = ttk.Combobox(current_course_frame, textvariable=self.var_dep, font=(
            "Arial", 10, "bold"), width=25, state="read only")
        ...
        class_student_frame = LabelFrame(
            main_frame, bd=2, bg="white", relief=RIDGE, text="Class student information", font=("Arial", 15, "bold"))
        ...
        studentID_entry = ttk.Entry(
            class_student_frame, textvariable=self.var_std_id, width=20)
        ...
        studentName_label = ttk.Entry(
            class_student_frame, textvariable=self.var_std_name, width=20)
        studentName_label.grid(row=0, column=3, padx=10, sticky=W)

        # studentDivision
        studentDiv_label = Label(class_student_frame, text="Student Division:", font=(
            "Arial", 13, "bold"), bg="white")
        ...
        # DOB:
        DOB_entry = Label(class_student_frame, text="dd-mm-yyyy:",
                          font=("Arial", 13, "bold"), bg="white")
        DOB_entry.grid(row=2, column=2, padx=2, pady=10, sticky=W)

        DOB_entry = ttk.Entry(class_student_frame,
                              textvariable=self.var_dob, width=20)
        DOB_entry.grid(row=2, column=3, padx=10, sticky=W)

        # email:
        studentemail_label = Label(
            class_student_frame, text="Email:", font=("Arial", 13, "bold"), bg="white")
        studentemail_label.grid(row=3, column=0, padx=2, pady=10, sticky=W)

        studentemail_label = ttk.Entry(
            class_student_frame, textvariable=self.var_email, width=20)
        studentemail_label.grid(row=3, column=1, padx=10, sticky=W)

        # phonenumber:
        studentph_label = Label(class_student_frame, text="Phone no:", font=(
            "Arial", 13, "bold"), bg="white")
        studentph_label.grid(row=3, column=2, padx=2, pady=10, sticky=W)

        studentph_label = ttk.Entry(
            class_student_frame, textvariable=self.var_phone, width=20)
        studentph_label.grid(row=3, column=3, padx=10, sticky=W)

        # address:
        studentaddress_label = Label(
            class_student_frame, text="Address:", font=("Arial", 13, "bold"), bg="white")
        studentaddress_label.grid(row=4, column=0, padx=2, pady=10, sticky=W)

        studentaddress_label = ttk.Entry(
            class_student_frame, textvariable=self.var_address, width=20)
        studentaddress_label.grid(row=4, column=1, padx=10, sticky=W)

        # teacher name :
        Teachername_label = Label(class_student_frame, text="Teachers name", font=(
            "Arial", 13, "bold"), bg="white")
        Teachername_label.grid(row=4, column=2, padx=2, pady=10, sticky=W)

        Teachername_label = ttk.Entry(
            class_student_frame, textvariable=self.var_teacher, width=20)
        ...
        save_btn = Button(btn_frame, text="SAVE", command=self.add_data, width=16, font=(
            "Arial", 13, "bold"), bg="#026573", fg="white")
        ...
        take_photo_btn = Button(btn1_frame, text="TAKE PHOTO", command=self.generate_dataset, width=67, font=(
            "Arial", 13, "bold"), bg="#026573", fg="white")
        ...
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                conn = mysql.connector.connect(
                    host="localhost", username="root", password="ishikaraj@123", database="database1")
    ...
    def delete_data(self):
        if self.var_std_id.get() == "":
            ...
            try:
                ...
                conn.close()
                messagebox.showinfo(
                    "Deleted", "Sucessfully deleted student details", parent=self.root)
            except Exception as es:
                messagebox.showerror(
                    "Error", f"Due to:{str(es)}", parent=self.root)
